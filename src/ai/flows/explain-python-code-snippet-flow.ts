...
const ExplainPythonCodeSnippetOutputSchema = z.object({
  explanation: z.string().describe('A structured 4-step explanation of the provided snippet or error.'),
});
...
Step 3: The Fix. Provide a clean, modular solution (code block or shell commands).
Step 4: Prevention. Give one "Expert" tip to avoid this issue in the future.`,
});
